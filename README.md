...
`./check.sh quick` **12 节全绿**：**257** 测试 · arena 5 · 警告零误报 · 泛型 3 · extern 4 ·
模块 12 · IO 10 · ASan 8 · 层号哨兵 98 语料零漂移 · **全限定名 8** · 攻击库与基线一致 ✓
（完整模式 **18 节** —— 多出的 6 节是基准 ✓ `tools/golden.sh check` 是**另一个脚本**：
