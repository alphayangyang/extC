...
typedef struct array_262144_i32 array_262144_i32;
...
void array_262144_i32_debug(array_262144_i32 v);
bool array_262144_i32_eq(array_262144_i32 a, array_262144_i32 b);
...
#line 7 "matmul.extc"
    while ((i < 262144)) {
#line 7 "matmul.extc"
        a.data[extc_checkedIndex((int64_t)(i), 262144, "matmul.extc", 7)] = 1;
#line 7 "matmul.extc"
        b.data[extc_checkedIndex((int64_t)(i), 262144, "matmul.extc", 7)] = 2;
#line 7 "matmul.extc"
        i = (i + 1);
    }
#line 8 "matmul.extc"
...
#line 14 "matmul.extc"
            while ((k < n)) {
#line 14 "matmul.extc"
                s = (s + (a.data[extc_checkedIndex((int64_t)(((x * n) + k)), 262144, "matmul.extc", 14)] * b.data[extc_checkedIndex((int64_t)(((k * n) + y)), 262144, "matmul.extc", 14)]));
#line 14 "matmul.extc"
                k = (k + 1);
            }
#line 15 "matmul.extc"
            c.data[extc_checkedIndex((int64_t)(((x * n) + y)), 262144, "matmul.extc", 15)] = s;
#line 16 "matmul.extc"
            y = (y + 1);
        }
#line 18 "matmul.extc"
...
#line 20 "matmul.extc"
    (slice_u8_writeText((slice_u8){ .data = (uint8_t *)"c[0] = ", .len = sizeof("c[0] = ") - 1 }), printf("%d", (int)(c.data[extc_checkedIndex((int64_t)(0), 262144, "matmul.extc", 20)])), printf("\n"));
#line 21 "matmul.extc"
    extc_arena_release(&__extc_arena);
    return 0;
}
