...
typedef struct array_10000001_bool array_10000001_bool;
...
struct array_10000001_bool {
    bool data[10000001];
};

array_10000001_bool composite;

void unit_debug(unit v);
void slice_u8_debug(slice_u8 v);
void slice_u8_writeText(slice_u8 v);
void array_10000001_bool_debug(array_10000001_bool v);
bool array_10000001_bool_eq(array_10000001_bool a, array_10000001_bool b);
...
#line 6 "sieve.extc"
    while ((i <= n)) {
#line 7 "sieve.extc"
        if ((!composite.data[extc_checkedIndex((int64_t)(i), 10000001, "sieve.extc", 7)])) {
#line 8 "sieve.extc"
            cnt = (cnt + 1);
#line 9 "sieve.extc"
            int64_t j = (i * i);
#line 10 "sieve.extc"
            while ((j <= n)) {
#line 10 "sieve.extc"
                composite.data[extc_checkedIndex((int64_t)(j), 10000001, "sieve.extc", 10)] = true;
#line 10 "sieve.extc"
                j = (j + i);
            }
        }
...
#line 14 "sieve.extc"
    (slice_u8_writeText((slice_u8){ .data = (uint8_t *)"pi = ", .len = sizeof("pi = ") - 1 }), printf("%lld", (long long)(cnt)), printf("\n"));
#line 15 "sieve.extc"
    extc_arena_release(&__extc_arena);
    return 0;
}
